...
SDS_ROOT = "/path/to/sds/archive"  # Update with your SDS root directory
NETWORK = "CV"
STATION = "GHM1,GHM2,GHM3"  # Update with your station codes
LOCATION = ""
CHANNEL = "HHZ"
STARTTIME = UTCDateTime(2024, 1, 1, 0, 0)  # Update with your start time
ENDTIME = STARTTIME + 3*3600  # 3 hours
PAD = 360  # s

# Coordinate file path (JSON format: {"STATION_CODE": [latitude, longitude, elevation], ...})
COORD_FILEPATH = "./coords_cvghm.json"
...
VOLC_COORDS = (0.0, 0.0)  # Update with (latitude, longitude)
